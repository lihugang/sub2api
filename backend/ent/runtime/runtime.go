...
func init() {
	...
	// accountDescOauthBillingMode is the schema descriptor for oauth_billing_mode field.
	accountDescOauthBillingMode := accountFields[13].Descriptor()
	// account.DefaultOauthBillingMode holds the default value on creation for the oauth_billing_mode field.
	account.DefaultOauthBillingMode = accountDescOauthBillingMode.Default.(bool)
	...
	// usagelogDescRecordType is the schema descriptor for record_type field.
	usagelogDescRecordType := usagelogFields[5].Descriptor()
	// usagelog.DefaultRecordType holds the default value on creation for the record_type field.
	usagelog.DefaultRecordType = usagelogDescRecordType.Default.(string)
	// usagelog.RecordTypeValidator is a validator for the "record_type" field. It is called by the builders before save.
	usagelog.RecordTypeValidator = usagelogDescRecordType.Validators[0].(func(string) error)
	...
	// userDescModelRoutingNoticeMode is the schema descriptor for model_routing_notice_mode field.
	userDescModelRoutingNoticeMode := userFields[19].Descriptor()
	// user.DefaultModelRoutingNoticeMode holds the default value on creation for the model_routing_notice_mode field.
	user.DefaultModelRoutingNoticeMode = userDescModelRoutingNoticeMode.Default.(string)
	// user.ModelRoutingNoticeModeValidator is a validator for the "model_routing_notice_mode" field. It is called by the builders before save.
	user.ModelRoutingNoticeModeValidator = userDescModelRoutingNoticeMode.Validators[0].(func(string) error)
