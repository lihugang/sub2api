...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "oauth_settlement_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "oauth_billing_mode", Type: field.TypeBool, Default: false},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "time_rate_rules", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "record_type", Type: field.TypeString, Size: 32, Default: "request"},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "model_routing_notice_mode", Type: field.TypeString, Default: "color"},
