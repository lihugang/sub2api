...
func (h *GatewayHandler) GeminiV1BetaModels(c *gin.Context) {
	...
	for {
		...
		service.SetGatewayAccountNotice(c, service.GatewayAccountNoticeGemini, noticePreviousAccountID, account, service.ModelRoutingNoticeModeForUser(apiKey.User))
