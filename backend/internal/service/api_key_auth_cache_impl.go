...
const apiKeyAuthSnapshotVersion = 20 // v20: include user routing notice/group profit control fields plus group search/audio/video_model_prices billing fields (force refresh of pre-fix snapshots)
