export default {
    accounts: {
      ...
      schedulerScore: {
        ...
        stickyShort: 'Sticky',
        ungrouped: 'Ungrouped',
        hint: 'Hover a score to inspect its terms within the current list-filtered candidate pool. When advanced scheduling is off, this is a preview and does not route requests.',
        scoreDetails: 'View scheduler score details for {group}',
        active: 'Advanced scheduling is enabled; the base score participates in routing',
        preview: 'Advanced scheduling is disabled; configuration preview only',
        base: 'Base {score}',
        stickyPotential: 'Sticky potential {score}',
        terms: {
          priority: 'Priority',
          load: 'Load',
          queue: 'Queue',
        ...
        priorityValue: 'raw {value}',
        loadValue: 'load {rate}% / concurrency {concurrency}',
        queueValue: 'waiting {count}',
        errorValue: 'EWMA {rate}%',
        ttftValue: 'EWMA {value} ms',
        noRuntimeSample: 'no runtime sample in this instance',
        noTTFTSample: 'no TTFT sample; neutral factor applied',
        normalizedFactor: 'normalized factor',
        stickyWeighted: 'Sticky weighting is enabled: previous_response +{previous}, session +{session}; only matching requests receive these additions.',
        stickyHardAffinity: 'Sticky weighting is disabled: previous_response_id and session_hash use hard affinity; it is not part of the base score.'
      },
