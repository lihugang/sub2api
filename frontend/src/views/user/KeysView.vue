            ...
            <div class="group/dropdown relative">
              ...
              >
                <GroupBadge
                  ...
                  :time-rate-rules="row.group.time_rate_rules"
                />
          ...
          >
            <template #selected="{ option }">
              <GroupBadge
                ...
                :time-rate-rules="(option as unknown as GroupOption).timeRateRules"
              />
        ...
        <div class="max-h-80 overflow-y-auto p-1.5">
          ...
          >
            <GroupOptionItem
              ...
              :time-rate-rules="option.timeRateRules"
...
interface GroupOption {
  ...
  timeRateRules?: import('@/types').TimeRateRule[]
...
const groupOptions = computed(() =>
  groups.value.map((group) => ({
    ...
    timeRateRules: group.time_rate_rules,
